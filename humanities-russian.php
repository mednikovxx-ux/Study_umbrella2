...
<head>
<?php
$pageTitle = 'Русский язык онлайн — подготовка к ЕГЭ и ОГЭ | Study Umbrella';
$pageDescription = 'Курсы русского языка онлайн: базовый курс, подготовка к ЕГЭ и ОГЭ. Индивидуальный подход и бесплатный пробный урок в Study Umbrella.';
$canonicalPath = '/humanities-russian.php';
$extraStyles = ['css/language.css', 'css/inner-switch.css', 'css/subject-hero.css'];
$courseSchema = [
  'name' => 'Курсы русского языка',
  'description' => 'Русский язык онлайн: базовый и продвинутый курс, подготовка к ЕГЭ и ОГЭ с индивидуальным преподавателем.',
];
include __DIR__ . '/partials/head-meta.php';

$showSwitcher = true;
$switcherLabel = 'Русский язык';
$switcherLinks = [
...
<body class="page-humanities" style="--subj-accent: var(--rus-accent);">
        ...
        <div class="hero-subj__row">
          ...
          <div class="hero-subj__left">
            ...
            <h1 class="hero-subj__title hero-enter">
              ...
              <span class="t t--accent">РУССКИЙ ЯЗЫК</span><br>
          ...
          <div class="hero-subj__right hero-enter" data-delay="2">
            ...
            <img class="hero-subj__img" src="img/hero-humanities.webp" alt="Русский язык">
          </div>
          ...
          <article class="teacher-card">
            <div class="teacher-card__photo-wrap">
              <div class="teacher-card__photo">
                <img src="img/teacher-1.jpg" alt="Антон Бердечевский" loading="lazy">
              </div>
            </div>
            <h3 class="teacher-card__name">Антон Бердечевский</h3>
            <p class="teacher-card__subject">Русский язык</p>
      ...
      <div class="programs-grid__top">
        ...
        <div class="programs-info">
         <br> <strong> Наша задача — <span class="programs-info__accent">
            провести вас сквозь мир удивительных открытий в русском языке.
      ...
      <div class="tracks">
        ...
        <article class="track-card">
          <div class="track-card__content">
            <h3 class="track-card__title">Начальный курс</h3>
        ...
        <article class="track-card">
          <div class="track-card__content">
            <h3 class="track-card__title">Продвинутый курс</h3>
            <p class="track-card__text">
              Правила чтения<br><br>
              Правила произношения<br><br>
              Базовая грамматика

...
<head>
<?php
$pageTitle = 'Обществознание онлайн — подготовка к ЕГЭ и ОГЭ | Study Umbrella';
$pageDescription = 'Курсы обществознания онлайн: базовый и продвинутый курс, подготовка к ЕГЭ и ОГЭ. Индивидуальный подход и бесплатный пробный урок в Study Umbrella.';
$canonicalPath = '/humanities-social.php';
$extraStyles = ['css/language.css', 'css/inner-switch.css', 'css/subject-hero.css'];
$courseSchema = [
  'name' => 'Курсы обществознания',
  'description' => 'Обществознание онлайн: базовый и продвинутый курс, подготовка к ЕГЭ и ОГЭ с индивидуальным преподавателем.',
];
include __DIR__ . '/partials/head-meta.php';

$showSwitcher = true;
$switcherLabel = 'Обществознание';
$switcherLinks = [
...
<body class="page-humanities" style="--subj-accent: var(--soc-accent);">
        ...
        <div class="hero-subj__row">
          ...
          <div class="hero-subj__left">
            ...
            <h1 class="hero-subj__title hero-enter">
              ...
              <span class="t t--accent">ОБЩЕСТВОЗНАНИЕ</span><br>
          ...
          <div class="hero-subj__right hero-enter" data-delay="2">
            ...
            <img class="hero-subj__img" src="img/hero-humanities.webp" alt="Обществознание">
          </div>
      ...
      <div class="teachers-slider__viewport">
        <div class="teachers-slider__track">
          ...
          <article class="teacher-card">
            ...
            <p class="teacher-card__subject">Обществознание</p>
      ...
      <div class="programs-grid__top">
        ...
        <div class="programs-info">
         <br> <strong> Наша задача — <span class="programs-info__accent">
            провести вас сквозь мир удивительных открытий в обществознании.

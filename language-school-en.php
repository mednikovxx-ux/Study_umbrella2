...
<head>
<?php
$pageTitle = 'Английский язык онлайн — курсы A1-B2 | Study Umbrella';
$pageDescription = 'Курсы английского языка онлайн: A1-A2, A2-B1, B1-B2, подготовка к CAE/IELTS. Индивидуальные занятия и мини-группы. Бесплатный пробный урок в Study Umbrella.';
$canonicalPath = '/language-school-en.php';
$extraStyles = ['css/language.css', 'css/inner-switch.css', 'css/subject-hero.css'];
$courseSchema = [
  'name' => 'Курсы английского языка',
  'description' => 'Английский язык онлайн: A1-A2, A2-B1, B1-B2, подготовка к CAE/IELTS с индивидуальным преподавателем.',
];
...
<body class="page-language" style="--subj-accent: var(--en-accent); --subj-on-accent: #ffffff;">
        ...
        <div class="hero-subj__row">
          ...
          <div class="hero-subj__left">
            ...
            <h1 class="hero-subj__title hero-enter">
              ...
              <span class="t t--accent">АНГЛИЙСКИЙ</span><br>
          ...
          <div class="hero-subj__right hero-enter" data-delay="2">
            <!-- TODO: заменить на реальное фото Лондона, как только оно появится в img/ -->
            <img class="hero-subj__img" src="img/hero-language.webp" alt="Английский язык">
          </div>
      ...
      <div class="teachers-slider__viewport">
        <div class="teachers-slider__track">
          ...
          <article class="teacher-card">
            <div class="teacher-card__photo-wrap">
              ...
              <div class="teacher-card__badge">
                <img src="img/badge-cae.png" alt="Сертификат" loading="lazy">
              </div>
            </div>
            <h3 class="teacher-card__name">Лапина Анна</h3>
            <p class="teacher-card__subject teacher-card__subject--english">Английский язык</p>
          ...
          <article class="teacher-card">
            <div class="teacher-card__photo-wrap">
              <div class="teacher-card__photo">
                <img src="img/teacher-2.jpg" alt="Винникова Валерия" loading="lazy">
              </div>
              <div class="teacher-card__badge">
                <img src="img/badge-cae2.png" alt="Сертификат IELTS" loading="lazy">
              </div>
            </div>
            <h3 class="teacher-card__name">Винникова Валерия</h3>
            <p class="teacher-card__subject teacher-card__subject--english">Английский язык</p>
          ...
          <article class="teacher-card">
            <div class="teacher-card__photo-wrap">
              <div class="teacher-card__photo">
                <img src="img/teacher-3.jpg" alt="Феактистова Арина" loading="lazy">
              </div>
              <div class="teacher-card__badge">
                <img src="img/badge-cae3.png" alt="Сертификат CAE" loading="lazy">
              </div>
            </div>
      ...
      <div class="tracks">
        ...
        <article class="track-card">
          <div class="track-card__content">
            <h3 class="track-card__title">Английский A1-A2</h3>
        ...
        <article class="track-card">
          <div class="track-card__content">
            <h3 class="track-card__title">Английский A2-B1</h3>
            <p class="track-card__text">
              Правила чтения<br><br>
              Правила произношения<br><br>
              Базовая грамматика
        ...
        <article class="track-card track-card--narrow">
          <div class="track-card__content">
            <h3 class="track-card__title">Английский B1-B2</h3>
            <p class="track-card__text">
              Правила чтения<br><br>
              Правила произношения<br><br>
              Базовая грамматика

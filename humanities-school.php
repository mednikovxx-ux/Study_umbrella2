...
<head>
<?php
$pageTitle = 'Гуманитарная школа — история, обществознание, русский язык | Study Umbrella';
$pageDescription = 'Гуманитарная онлайн-школа Study Umbrella: история, обществознание и русский язык, подготовка к ЕГЭ и ОГЭ с индивидуальным подходом. Бесплатный пробный урок.';
$canonicalPath = '/humanities-school.php';
$extraStyles = ['css/language.css', 'css/inner-switch.css'];
include __DIR__ . '/partials/head-meta.php';
?>
</head>

<body class="page-humanities">
  ...
  <div class="container hero__inner">
    ...
    <div class="hero__content">
      ...
      <div class="hero__cta hero-enter" data-delay="2">
        ...
        <img src="img/cta-decor2.png" alt="" class="hero__cta-decor" loading="lazy">
      </div>

      <img src="img/hero-arrow3.png" alt="" class="hero__arrow" loading="lazy">
    </div>

    <div class="hero__image-wrap hero-enter" data-delay="2">
      <img src="img/hero-humanities.webp" alt="Гуманитарная онлайн-школа" class="hero__image">
    </div>
...
<section class="section" id="about">
  <div class="container">
    <div class="about-text">
      <p class="about-line">
        <strong>Подготовьтесь к сложным экзаменам легко и эффективно</strong>
      ...
      <div class="tracks">
        ...
        <article class="track-card">
          <div class="track-card__image-wrap">
            <img src="img/humanities-1.webp" alt="Курсы истории" class="track-card__image" loading="lazy">
          </div>
          <div class="track-card__content">
            <h3 class="track-card__title">История.</h3>
            <p class="track-card__text">
              Всеобщая история<br><br>
              История России<br><br>
              История ХХ-ХХI века<br><br>
              Подготовка к ОГЭ/ЕГЭ
            </p>
            <a href="humanities-history.php" class="track-card__arrow">
        ...
        <article class="track-card">
          <div class="track-card__image-wrap">
            <img src="img/humanities-2.webp" alt="Курсы обществознания" class="track-card__image" loading="lazy">
          </div>
          <div class="track-card__content">
            <h3 class="track-card__title">Обществознание.</h3>
            <p class="track-card__text">
              Обществознание для школы<br><br>
              Обществознание для университета<br><br>
              Подготовка к ОГЭ/ЕГЭ
            </p>
            <a href="humanities-social.php" class="track-card__arrow">
              <img src="img/track-arrow.png" alt="Подробнее" loading="lazy">
            </a>
          </div>
        </article>
        ...
        <article class="track-card track-card--narrow">
          <div class="track-card__image-wrap">
            <img src="img/humanities-3.webp" alt="Курсы русского языка" class="track-card__image" loading="lazy">
          </div>
          <div class="track-card__content">
            <h3 class="track-card__title">Русский язык.</h3>
            <p class="track-card__text">
              Базовый курс русского языка<br><br>
              Подготовка к ОГЭ/ЕГЭ
            </p>
            <a href="humanities-russian.php" class="track-card__arrow">
              <img src="img/track-arrow.png" alt="Подробнее" loading="lazy">
            </a>
          </div>
        </article>

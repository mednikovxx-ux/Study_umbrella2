...
<head>
<?php
$pageTitle = 'Испанский язык онлайн — курсы A1-B2 | Study Umbrella';
$pageDescription = 'Курсы испанского языка онлайн: A1-A2, A2-B1, B1-B2, подготовка к DELE. Индивидуальные занятия и мини-группы. Бесплатный пробный урок в Study Umbrella.';
$canonicalPath = '/language-school-es.php';
$extraStyles = ['css/language.css', 'css/inner-switch.css', 'css/subject-hero.css'];
$courseSchema = [
  'name' => 'Курсы испанского языка',
  'description' => 'Испанский язык онлайн: A1-A2, A2-B1, B1-B2, подготовка к DELE с индивидуальным преподавателем.',
];
include __DIR__ . '/partials/head-meta.php';

$showSwitcher = true;
$switcherLabel = 'Español';
$switcherLinks = [
...
<body class="page-language" style="--subj-accent: var(--es-accent);">
        ...
        <div class="hero-subj__row">
          ...
          <div class="hero-subj__left">
            ...
            <h1 class="hero-subj__title hero-enter">
              ...
              <span class="t t--accent">ИСПАНСКИЙ</span><br>
          ...
          <div class="hero-subj__right hero-enter" data-delay="2">
            <!-- TODO: заменить на реальное фото площади Сибелес, как только оно появится в img/ -->
            <img class="hero-subj__img" src="img/hero-language.webp" alt="Испанский язык">
          </div>
      ...
      <div class="teachers-slider__viewport">
        <div class="teachers-slider__track">
          ...
          <article class="teacher-card">
            ...
            <p class="teacher-card__subject teacher-card__subject--spanies">Испанский язык</p>
          ...
          <article class="teacher-card">
            <div class="teacher-card__photo-wrap">
              ...
              <div class="teacher-card__badge">
                <img src="img/badge-cae2.png" alt="Сертификат DELE" loading="lazy">
              </div>
            </div>
          ...
          <article class="teacher-card">
            <div class="teacher-card__photo-wrap">
              ...
              <div class="teacher-card__badge">
                <img src="img/badge-cae3.png" alt="Сертификат DELE" loading="lazy">
              </div>
            </div>
      ...
      <div class="tracks">
        ...
        <article class="track-card">
          <div class="track-card__content">
            <h3 class="track-card__title">Испанский A1-A2</h3>
        ...
        <article class="track-card">
          <div class="track-card__content">
            <h3 class="track-card__title">Испанский A2-B1</h3>
            <p class="track-card__text">
              Правила чтения<br><br>
              Правила произношения<br><br>
              Базовая грамматика
        ...
        <article class="track-card track-card--narrow">
          <div class="track-card__content">
            <h3 class="track-card__title">Испанский B1-B2</h3>
            <p class="track-card__text">
              Правила чтения<br><br>
              Правила произношения<br><br>
              Базовая грамматика
